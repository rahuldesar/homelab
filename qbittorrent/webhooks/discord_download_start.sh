...
discord_webhook_url="https://discord.com/api/webhooks/$DISCORD_WEBHOOK_ID/$DISCORD_WEBHOOK_TOKEN"  # Update with your Discord webhook URL
    ...
    "embeds": [
        {
            ...
            "title": "🚀🚀 '$download_type' download started 🚀🚀",
            "color": 7506394,
            "fields": [
                {
                    "name": "Torrent",
